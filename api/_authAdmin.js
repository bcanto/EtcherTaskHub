...
// Same token validation as requireAdminCaller, minus the admin-role requirement — for
// endpoints ANY signed-in session (staff or client) may legitimately call. notify-email is
// the first: a client session reaching the return-to-owner notification after responding to
// an action request must still be able to fire it, and requireAdminCaller would 403 them.
...
module.exports = { requireAdminCaller, requireAuthedCaller, requireClientCaller };
